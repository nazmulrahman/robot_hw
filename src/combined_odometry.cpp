...
class CombinedOdometryPublisher : public rclcpp::Node
{
  public:
    CombinedOdometryPublisher() : Node("combined_odom_publisher_node")
    {
        ...
        ticks_subscription = this->create_subscription<geometry_msgs::msg::Vector3>("ticks", 10, std::bind(&CombinedOdometryPublisher::ticks_callback, this, _1));
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<CombinedOdometryPublisher>());
  rclcpp::shutdown();
  return 0;
}